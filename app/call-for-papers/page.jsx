...
export default function Home() {
    return (
        <div className="flex flex-col overflow-clip rounded-3xl bg-white">
            <main className="container mx-auto mt-28 flex flex-col px-5">
                <div className="flex flex-col gap-6 lg:mx-5">
                    <div className="flex w-full flex-col gap-8 rounded-lg bg-zinc-50 bg-gradient-to-b p-5 outline outline-1 outline-zinc-100 sm:gap-10 sm:px-8 sm:pb-8 sm:pt-10 lg:max-w-lg lg:pb-24">
                ...
                <div className="relative bottom-10 z-10 h-28 w-full self-center bg-gradient-to-r from-amber-500 via-orange-500 via-30% to-[#ff2d68] blur-[32px]" />
                <div className="relative bottom-28 z-20">
                    <a
                ...
                <div className="mt-8 grid grid-cols-8 gap-4">
                    <div className="col-span-full flex flex-col gap-8 rounded-lg bg-zinc-900 p-5 sm:gap-10 sm:p-8 2xl:col-span-3">
                        <div className="flex flex-col gap-2">
                            <div className="font-body text-[0.65rem] font-medium uppercase text-zinc-400 sm:text-xs">
                                Status / Open
                            </div>
                        ...
                        <p className="font-body text-base text-zinc-500">
                            ...
                            IndiaHCI&apos;s electronic submission system
                            supported by Microsoft CMT.
                        </p>
                    </div>
                    <div className="col-span-full flex flex-col gap-8 rounded-lg bg-zinc-900 p-5 sm:gap-10 sm:p-8 2xl:col-span-5">
                        <div className="flex flex-col gap-2">
                            <div className="font-body text-[0.65rem] font-medium uppercase text-zinc-400 sm:text-xs">
                                From The Chairs
                            </div>
                ...
                <div className="my-28 flex flex-col gap-6">
                    ...
                    <div className="font-body text-base text-zinc-900">
                        <p className="">
                            ...
                            tangible & ubiquitous computing, virtual & augmented
                            reality, multimedia, new input & output devices,
                            computer games, privacy, security, visualization,
                            health, accessibility and ageing, design, user
                            modelling, engineering interactive systems, ICT for
                            development, CSCW, and more. India HCI provides a
                            special spotlight on papers that are relevant to
                            South Asia, including those related to culture,
                            language, socio-economic situations, and the
                            industry from the region. The intimate size, single
                            track, and comfortable surroundings make this
                            conference an ideal opportunity to exchange research
                            results and implementation experiences.
                        </p>
                    </div>
                </div>
                <div className="flex min-h-[4.5rem] items-start gap-3 rounded-lg bg-gradient-to-r from-amber-500  to-[#FF0048] p-4 text-transparent lg:items-center">
                    <Icon
                        className="h-6 w-6 shrink-0 text-white"
                        icon="solar:verified-check-bold"
                    />
                    <p className="font-body text-base text-white">
                        Accepted papers will be published in the India HCI 2023
                        Conference Proceedings and will be included in the ACM
                        Digital Library
                    </p>
                </div>
                <div className="my-28 flex flex-col gap-6">
                    ...
                    <div className="font-body text-base text-zinc-900">
                        <p className="">
                            ...
                            includes all dimensions, e.g., people, product,
                            tools, processes, and industrial applications, with
                            research results contributing to its understanding
                            and support. Significantly novel enabling
                            technologies such as innovative input devices,
                            displays, new interaction techniques, or new media
                            that extend the boundaries of traditional
                            interaction, such as natural user interfaces and
                            interactions, mixed reality, mobile interaction,
                ...
                <div className="flex min-h-[4.5rem] items-start gap-3 rounded-lg bg-gradient-to-r from-amber-500  to-[#FF0048] p-4 text-transparent lg:items-center">
                    ...
                    />
                    <p className="font-body text-base text-white">
                        All papers should be submitted electronically through to
                        India HCI through TBA.
                    </p>
                </div>
                <div className="mb-16 mt-28 flex flex-col gap-6">
                    ...
                    <div className="columns-1 font-body text-base text-zinc-900 lg:columns-2">
                        <p className="mb-10">
                            To be considered Full Papers, contributions should
                            be more than six pages long (single column
                            template). There is no hard page limit, but long
                            papers without a proportional contribution are more
                            likely to be rejected. Previous papers (if converted
                            to the new ACM single-column format) would have run
                            14-18 pages in length.
                        </p>
                        <p className="mb-10">
                            Videos accompanying submissions can be submitted
                            through the India HCI Microsoft CMT Electronic
                            Submission Site as supplementary material (max 100
                            MB in size). Although papers must stand on their
                            own, submitted videos will be available to reviewers
                            as supporting material. Authors should note that no
                            specific guidelines are given for developing a
                            video. Videos are viewed only as supporting
                            material, and authors of accepted papers will have
                            the opportunity to prepare a more polished final
                            video presentation for inclusion in the proceedings
                            and as supplemental material in the ACM Digital
                            Library. Authors should note that videos too need to
                            maintain anonymity for the review process. Authors
                            are free to update the video once their submission
                        ...
                        <p className="mt-10">
                            ...
                            additional codecs. Please note that the total
                            aggregate size for a submission must not exceed 100
                            MBs (including all documents and additional
                            material).
                        </p>
                    </div>
                </div>
                <div className="mb-6 flex min-h-[4.5rem] items-center gap-3 rounded-3xl bg-zinc-900 px-8 shadow-xl transition duration-300 hover:scale-[1.02] hover:bg-zinc-800">
